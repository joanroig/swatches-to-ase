...
export const playgroundStyleText = document.querySelector<HTMLSpanElement>("#playground-style-text");
...
export const discoverFollowingOnlyToggle = document.querySelector<HTMLInputElement>("#discover-following-only");
