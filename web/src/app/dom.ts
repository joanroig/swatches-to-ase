...
export const brandHomeButtons = Array.from(document.querySelectorAll<HTMLButtonElement>("[data-home]"));
...
export const editorToolbar = document.querySelector<HTMLDivElement>(".editor-toolbar");
export const editorToolbarSpacer = document.querySelector<HTMLSpanElement>(".editor-toolbar-spacer");
...
export const exportFormatButtons = Array.from(document.querySelectorAll<HTMLButtonElement>("[data-export-format]"));
...
export const viewBlocks = document.querySelector<HTMLDivElement>("#view-blocks");
export const viewLayoutButtons = Array.from(document.querySelectorAll<HTMLButtonElement>("[data-view-layout]"));
