...
export const cookieBanner = document.querySelector<HTMLDivElement>("#cookie-banner");
export const cookieAcceptButton = document.querySelector<HTMLButtonElement>("#cookie-accept");
export const cookieDeclineButton = document.querySelector<HTMLButtonElement>("#cookie-decline");
export const cookieManageButton = document.querySelector<HTMLButtonElement>("#cookie-manage");
